...
from ProjetNarouto.code.card_image import * #Chargement des cartes

from ProjetNarouto.code.map_image import  * #Chargement de la map

from ProjetNarouto.code.create_case import *


def main():

    # Création des joueurs1
    joueur1 = Player("J1",20, 1,rect_board,rect_hand)
    joueur2 = Player( "J2",20, 1,rect_board2,rect_hand)
