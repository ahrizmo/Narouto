...
class Card:
    def __init__(self, name: str, type: TypeCard, pv: List[int], att: List[int], nature: ElementalChakra, cost: int,img):#, passif: List[Callable]):
        self.name = name
        self.type = type
        self.pvMax = pv
    ...
    def draw(self,rect):
        ...
        self.img.blit(font.render(str(sum(self.att)), True, (0,0,0)), (rect.x+10, rect.y+50))
        self.img.blit(font.render(str(self.PV), True, (0,0,0)), (rect.x+50,rect.y+50))
