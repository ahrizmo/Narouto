...
def get_img_path(card_id,case_id,cartes_main, cartes_main_small, main_Narouto):
    noms_cartes = [
    ...
    for i in range(5):
        if main_Narouto[i] == card_id:
            main_Narouto[i] = None
            cartes_main[i] = None   
            carte1 = write_on_card(main_Narouto[i],carte1,True)
            cartes_small = write_on_card(main_Narouto[i],cartes_small,False)     
...
def write_on_card(card,card_render,bool):
    if card != None:
        font = pygame.font.SysFont("Permanent Marker", 30) 
        attack = font.render(f"{sum(card.att)}", True, (0, 0, 0))
        pv = font.render(f"{card.PV}", True, (0, 0, 0))
        chakra = font.render(f"{card.cost}", True, (0, 0, 0))

        if bool:
            card_render.blit(attack, (45, 25))
            card_render.blit(pv, (360,505))
            card_render.blit(chakra, (10, 530))
        else:
            card_render.blit(attack, (12, 8))
            card_render.blit(pv, (150,130))
            card_render.blit(chakra, (0, 130))
...
def load_card(cartes_Narouto,cartes_Sasouke,main_Sasouke,main_Narouto,cartes, cartes_small,cartes_main,cartes_main_small,turn):
    global  case1, case2, case3, case4, case5, case6, case7, case8
    global  case11, case12, case13, case14, case15, case16, case17, case18
    ...
    for i in range(8):
        if cartes_Sasouke[i//4][i%4] != None:
            j = cartes_Sasouke[i//4][i%4].id
            ...
            carte1 = write_on_card(cartes_Sasouke[i//4][i%4],carte1,True)
            carte_small_img = write_on_card(cartes_Sasouke[i//4][i%4], carte_small_img,False)
    ...
    for i in range(8):
        if cartes_Narouto[i//4][i%4] != None:
            j = cartes_Narouto[i//4][i%4].id
            chemin = f"../CartesMinis/{noms_cartes[j]}.png"
            carte_small_img = pygame.image.load(chemin).convert_alpha()
    ...
    if turn:
        for i in range(5):
            ...
            if main_Narouto[i] != None:
                ...
                carte1 = write_on_card(cartes_Narouto[i//4][i%4],carte1,True)
                carte_small_img = write_on_card(cartes_Narouto[i//4][i%4], carte_small_img,False)
        ...
        for i in range(5):
            ...
            if main_Sasouke[i] != None:

                j = main_Sasouke[i].id

                chemin = f"../CartesMinis/{noms_cartes[j]}.png"
                carte_small_img = pygame.image.load(chemin).convert_alpha()
                tab_main_Sasouke[i].carte_posee = j
                cartes_main_small.append(carte_small_img)
...
def afficher_jeu(etat,cartes_Narouto,cartes_Sasouke,main_Sasouke,main_Narouto,cartes,cartes_small,cartes_main,cartes_main_small,turn):
    ...
    load_card(cartes_Narouto,cartes_Sasouke,main_Sasouke,main_Narouto,cartes, cartes_small,cartes_main,cartes_main_small,turn)
    ...
    while running:  
        ...
        for event in pygame.event.get() :
            if event.type == pygame.QUIT:
                ...
                if 0 <= click_x <= 287 and 588 <= click_y <= 628:
                    # Code pour skip
                    etat["nbr_play"] = 0
                    ...
                    print("turn")
                    print("Skip")
                elif 0 <= click_x <= 287 and 325 <= click_y <= 365:
                    # Code pour skip
                    etat["nbr_play"] = 0
                    screen.fill(black_color)
                    pygame.display.flip()
                ...
                if 410 <= click_x <= 590 and 50 <= click_y <= 200:
                    if case1.carte_posee != None:
                        ...
                        cartes[0], cartes_small[0] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case2.carte_posee != None:
                        ...
                        cartes[1], cartes_small[1] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    case1.click,case3.click,case4.click,case5.click,case6.click,case7.click,case8.click = mise_a_false()
                    ...
                    if case3.carte_posee != None:
                        ...
                        cartes[2], cartes_small[2] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case4.carte_posee != None:
                        ...
                        cartes[3], cartes_small[3] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case5.carte_posee != None:
                        ...
                        cartes[4], cartes_small[4] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case6.carte_posee != None:
                        ...
                        cartes[5], cartes_small[5] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case7.carte_posee != None:
                        ...
                        cartes[6], cartes_small[6] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case8.carte_posee != None:
                        ...
                        cartes[7], cartes_small[7] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                ...
                if 410 <= click_x <= 590 and 590 <= click_y <= 740:
                    if case11.carte_posee != None:
                        ...
                        cartes[8], cartes_small[8] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case12.carte_posee != None:
                        ...
                        cartes[9], cartes_small[9] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case13.carte_posee != None:
                        ...
                        cartes[10], cartes_small[10] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case14.carte_posee != None:
                        ...
                        cartes[11], cartes_small[11] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case15.carte_posee != None:
                        ...
                        cartes[12], cartes_small[12] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case16.carte_posee != None:
                        ...
                        cartes[13], cartes_small[13] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case17.carte_posee != None:
                        ...
                        cartes[14], cartes_small[14] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
                    ...
                    if case18.carte_posee != None:
                        ...
                        cartes[15], cartes_small[15] = get_img_path(card_hand_selected,case_hand_selected,cartes_main, cartes_main_small, main_Narouto)
